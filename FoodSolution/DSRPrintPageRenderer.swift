...
class DSRPrintPageRenderer: UIPrintPageRenderer {
    
    
    let DSRPageWidth: CGFloat = 595.2
    let DSRPageHeight: CGFloat = 1841.8
    
    let FASAPageWidth: CGFloat = 1595.2
    let FASAPageHeight: CGFloat = 1841.8
    ...
    override init() {
        ...
        let pageFrame = CGRect(x: 0.0, y: 0.0, width: FASAPageWidth, height: FASAPageHeight)
